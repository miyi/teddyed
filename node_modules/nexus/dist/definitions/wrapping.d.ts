...
export declare type AllNexusInputTypeDefs<T extends string = string> = NexusInputObjectTypeDef<T> | NexusEnumTypeDef<T> | NexusScalarTypeDef<T>;
export declare type AllNexusOutputTypeDefs = NexusObjectTypeDef<string> | NexusInterfaceTypeDef<string> | NexusUnionTypeDef<string> | NexusEnumTypeDef<string> | NexusScalarTypeDef<string>;
...
export declare type WrappedTypeFn<T extends AllNexusNamedTypeDefs> = (builder: SchemaBuilder) => T;
/**
 ...
 * @param fn
 */
export declare function nexusWrappedType<T extends AllNexusNamedTypeDefs>(name: string, fn: WrappedTypeFn<T>): NexusWrappedType<T>;
export declare function isNexusTypeDef(obj: any): obj is {
...
export declare function isNexusWrappedType(obj: any): obj is NexusWrappedType<AllNexusNamedTypeDefs>;
