...
export declare type Implemented = GetGen<"interfaceNames"> | NexusInterfaceTypeDef<string>;
...
export interface ObjectDefinitionBuilder<TypeName extends string> extends OutputDefinitionBuilder {
    ...
    addFieldModifications<FieldName extends string>(changes: FieldModificationDef<TypeName, FieldName>): void;
}
export declare class ObjectDefinitionBlock<TypeName extends string> extends OutputDefinitionBlock<TypeName> {
     ...
     */
    modify<FieldName extends Extract<keyof GetGen2<"fieldTypes", TypeName>, string>>(field: FieldName, modifications: FieldModification<TypeName, FieldName>): void;
}
...
export declare class NexusObjectTypeDef<TypeName extends string> {
    ...
    readonly value: NexusObjectTypeConfig<TypeName>;
}
