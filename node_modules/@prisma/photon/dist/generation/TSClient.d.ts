...
export declare class TSClient {
    ...
    constructor({ document, datamodel, runtimePath, browser, datasources, generator, platforms, sqliteDatasourceOverrides, schemaDir, outputDir, }: TSClientOptions);
    toString(): string;
}
export declare class Model {
    ...
    protected readonly argsTypes: Stringifiable[];
    toString(): string;
}
