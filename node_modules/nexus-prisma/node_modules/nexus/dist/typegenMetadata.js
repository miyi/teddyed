...
var TypegenMetadata = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!this.config.outputs.typegen) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.generateTypesFile(sortedSchema, schema.extensions.nexus, this.config.outputs.typegen)];
                    case 3:
                        value = _a.sent();
                        return [4 /*yield*/, this.writeFile("types", value, this.config.outputs.typegen)];
                    case 4:
                        _a.sent();
                        _a.label = 5;
    ...
    TypegenMetadata.prototype.writeFile = function (type, output, filePath) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var fs, util, _a, readFile, writeFile, removeFile, mkdir, formatTypegen, content, _b, _c, toSave, existing, dirPath, e_1, e_2;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 10:
                        ...
                        return [3 /*break*/, 11];
                    case 11: return [2 /*return*/, writeFile(filePath, toSave)];
     ...
     */
    TypegenMetadata.prototype.generateTypesFile = function (schema, extensions, typegenFile) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, _b, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1: return [2 /*return*/, new (_a.apply(typegen_1.Typegen, _b.concat([tslib_1.__assign.apply(void 0, _c.concat([(_d.sent()), { typegenFile: typegenFile }])), extensions])))().print()];
                }
            });
        });
    };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                if (this.config.typegenConfig) {
                    ...
                    return [2 /*return*/, this.config.typegenConfig(schema, this.config.outputs.typegen || "")];
                }
                if (this.config.typegenAutoConfig) {
                    return [2 /*return*/, typegenAutoConfig_1.typegenAutoConfig(this.config.typegenAutoConfig)(schema, this.config.outputs.typegen || "")];
                }
                return [2 /*return*/, {
