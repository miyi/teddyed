...
export declare type NexusArgConfigType<T extends AllInputTypes> = T | AllNexusInputTypeDefs<T> | NexusWrappedType<AllNexusInputTypeDefs<T>>;
...
export declare class NexusArgDef<TypeName extends AllInputTypes> {
    ...
    readonly value: NexusArgConfig<TypeName>;
}
/**
