import { AbstractTypeResolver, FieldResolver, GetGen, HasGen3, NeedsResolver, AuthorizeResolver, GetGen3, AllInputTypes } from "../typegenTypeHelpers";
import { ArgsRecord } from "./args";
import { AllNexusOutputTypeDefs, NexusWrappedType, AllNexusInputTypeDefs } from "./wrapping";
...
export interface CommonOutputFieldConfig<TypeName extends string, FieldName extends string> extends CommonFieldConfig {
    /**
...
export interface NexusOutputFieldConfig<TypeName extends string, FieldName extends string> extends OutputScalarConfig<TypeName, FieldName> {
    type: GetGen<"allOutputTypes", string> | AllNexusOutputTypeDefs | NexusWrappedType<AllNexusOutputTypeDefs>;
}
