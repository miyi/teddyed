...
export declare type PostScalars = 'id' | 'content' | 'createdAt' | 'published' | 'title' | 'updatedAt';
...
export declare type UserSelect = {
    ...
    email?: boolean;
    name?: boolean;
    post?: boolean | FindManyPostSelectArgsOptional;
};
export declare type UserInclude = {
    post?: boolean | FindManyPostIncludeArgsOptional;
};
...
declare type UserGetSelectPayload<S extends boolean | UserSelect> = S extends true ? User : S extends UserSelect ? {
    [P in CleanupNever<MergeTruthyValues<{}, S>>]: P extends UserScalars ? User[P] : P extends 'post' ? Array<PostGetSelectPayload<ExtractFindManyPostSelectArgs<S[P]>> | null> : never;
} : never;
declare type UserGetIncludePayload<S extends boolean | UserInclude> = S extends true ? User : S extends UserInclude ? {
    [P in CleanupNever<MergeTruthyValues<UserDefault, S>>]: P extends UserScalars ? User[P] : P extends 'post' ? Array<PostGetIncludePayload<ExtractFindManyPostIncludeArgs<S[P]>> | null> : never;
} : never;
...
export declare class UserClient<T> implements Promise<T> {
    ...
    constructor(_dmmf: DMMFClass, _fetcher: PhotonFetcher, _queryType: 'query' | 'mutation', _rootField: string, _clientMethod: string, _args: any, _path: string[], _isList?: boolean);
    readonly [Symbol.toStringTag]: 'PhotonPromise';
    post<T extends FindManyPostArgs = {}>(args?: Subset<T, FindManyPostArgs>): T extends FindManyPostArgsRequired ? 'Please either choose `select` or `include`' : T extends FindManyPostSelectArgs ? Promise<Array<PostGetSelectPayload<ExtractFindManyPostSelectArgs<T>>>> : T extends FindManyPostIncludeArgs ? Promise<Array<PostGetIncludePayload<ExtractFindManyPostIncludeArgs<T>>>> : Promise<Array<Post>>;
    private readonly _document;
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
...
export declare type UserCreateWithoutPostInput = {
    id?: string | null;
    email: string;
    name?: string | null;
};
...
export declare type UserUpdateWithoutPostDataInput = {
    id?: string | null;
    email?: string | null;
    name?: string | null;
};
export declare type UserUpsertWithoutPostInput = {
    update: UserUpdateWithoutPostDataInput;
    create: UserCreateWithoutPostInput;
};
export declare type UserUpdateOneWithoutPostInput = {
    create?: UserCreateWithoutPostInput | null;
    connect?: UserWhereUniqueInput | null;
...
export declare type PostUpdateInput = {
    ...
    title?: string | null;
    updatedAt?: Date | string | null;
    author?: UserUpdateOneWithoutPostInput | null;
};
...
export declare type PostCreateManyWithoutPostInput = {
...
export declare type UserCreateInput = {
    ...
    email: string;
    name?: string | null;
    post?: PostCreateManyWithoutPostInput | null;
};
