...
class Photon {
    constructor(options = {}) {
        ...
        this.engine = new runtime_1.Engine({
            ...
            datasources,
            generator: { "name": "photon", "provider": "photonjs", "output": "/Users/mingyin/dev/lab6/Teddy/withPrisma/server/hello-heroku-retry/node_modules/@generated/photon", "binaryTargets": [], "config": {} },
        });
...
class UserClient {
    ...
    post(args) {
        const prefix = this._path.includes('select') ? 'select' : this._path.includes('include') ? 'include' : 'select';
        const path = [...this._path, prefix, 'post'];
        const newArgs = runtime_1.deepSet(this._args, path, args || true);
        this._isList = true;
